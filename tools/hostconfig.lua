  ApplicationId = "jp.co.makotok.flowersamples" --be sure to change this!
  AppName = "Flower Samples"
  CompanyName = ""
  -- Set flower-samples/bin Path.
  LuaSrc = "/Users/mkinoshita/moai-work/Hanappe/projects/flower-samples/bin"
  HostSettings = {
    ["android-gradle"] = {
       SdkDir = "",
       NdkDir = "",
