return {
    ...
    {title = "Aspect", scene = "samples/aspect_sample", openAnime = "fade", closeAnime = "fade"},
    ...
    {title = "Task Library 1", scene = "samples/tasklib_1_sample", openAnime = "fade", closeAnime = "fade"},
}
