...
M.NORMAL = {
    ...
    ImageButton = {
        ...
        disabledTexture = "skins/imagebutton_normal.png",
        fontName = "VL-PGothic.ttf",
        textSize = 20,
        textColor = {0, 0, 0, 1},
        textDisabledColor = {0.5, 0.5, 0.5, 1},
    ...
    SheetButton = {
        ...
        normalTexture = "skins/imagebutton_normal.9.png",
        selectedTexture = "skins/imagebutton_selected.9.png",
        disabledTexture = "skins/imagebutton_normal.9.png",
        fontName = "VL-PGothic.ttf",
        textSize = 20,
        textColor = {0, 0, 0, 1},
        textDisabledColor = {0.5, 0.5, 0.5, 1},
