return {
    ...
    {title = "Widget TextLabel", scene = "scenes/widget_textlabel_sample", openAnime = "fade", closeAnime = "fade"},
    ...
    {title = "Widget ScrollGroup", scene = "scenes/widget_scrollgroup_sample", openAnime = "slideLeft", closeAnime = "fade"},
    {title = "Widget ScrollView 1", scene = "scenes/widget_scrollview_1_sample", openAnime = "slideRight", closeAnime = "fade"},
    {title = "Widget ScrollView 2", scene = "scenes/widget_scrollview_2_sample", openAnime = "fade", closeAnime = "fade"},
    {title = "Widget PanelView", scene = "scenes/widget_panelview_sample", openAnime = "fade", closeAnime = "fade"},
    {title = "Widget TextView", scene = "scenes/widget_textview_sample", openAnime = "popIn", closeAnime = "popOut"},
    {title = "Widget ListView", scene = "scenes/widget_listview_sample", openAnime = "fade", closeAnime = "fade"},
