...
-- コンストラクタです
---------------------------------------
function M:new(targets, sec, easeType)
    local obj = {
        internal = {
            commands = {},
            targets = targets or {},
...
-- 対象オブジェクトを移動させます.
---------------------------------------
function I:moveLoc(moveX, moveY, moveZ, sec, mode)
...
-- 対象オブジェクトを移動させます.
---------------------------------------
function I:seekLoc(moveX, moveY, moveZ, sec, mode)
    local actionFunc = function(target, tSec, tMode)
...
-- 対象オブジェクトを回転させます.
---------------------------------------
function I:moveRot(rx, ry, rz, sec, mode)
    local actionFunc = function(target, tSec, tMode)
...
-- 対象オブジェクトを回転させます.
---------------------------------------
function I:seekRot(rx, ry, rz, sec, mode)
...
-- 対象オブジェクトを拡大します.
---------------------------------------
function I:moveScl(scaleX, scaleY, scaleZ, sec, mode)
    local actionFunc = function(target, sec, mode)
...
-- 対象オブジェクトを拡大します.
---------------------------------------
function I:seekScl(scaleX, scaleY, scaleZ, sec, mode)
    local actionFunc = function(target, sec, mode)
...
-- 対象オブジェクトの属性値を設定します.
---------------------------------------
function I:setAttr(attrID, value)
    local playFunc = function(obj, callback)
        for i, v in ipairs(self.internal.targets) do
...
-- 対象オブジェクトの属性値を設定します.
---------------------------------------
function I:moveAttr(attrID, value, sec, mode)
    local actionFunc = function(target, sec, mode)
...
-- 対象オブジェクトの属性値を設定します.
---------------------------------------
function I:seekAttr(attrID, value, sec, mode)
    local actionFunc = function(target, sec, mode)
...
---------------------------------------
function I:setIndex(index, sec, mode)
    local playFunc = function(obj, callback)
        for i, v in ipairs(self.internal.targets) do
            v:setIndex(index)
        end
...
-- 対象オブジェクトのindex値を設定します.
---------------------------------------
function I:moveIndex(indexes, sec, mode)
...
-- 対象オブジェクトの色を設定します.
---------------------------------------
function I:setColor(red, green, blue, alpha)
    local playFunc = function(obj, callback)
        for i, v in ipairs(self.internal.targets) do
...
---------------------------------------
function I:moveColor(red, green, blue, alpha, sec, mode)
    local actionFunc = function(target, sec, mode)
...
-- 対象オブジェクトの色をアニメーションします.
---------------------------------------
function I:seekColor(red, green, blue, alpha, sec, mode)
    local actionFunc = function(target, sec, mode)
...
-- @param ... アニメーション
---------------------------------------
function I:loop(maxCount, animation)
    local internal = self.internal
...
-- コマンドを実行します.
---------------------------------------
function I:executeCommand(index)
    local internal = self.internal
...
---------------------------------------
function I:newCommand(playFunc, stopFunc)
...
-- @return command コマンドテーブル
---------------------------------------
function I:newActionCommand(actionFunc, sec, mode)
    local internal = self.internal
